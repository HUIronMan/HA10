...
\section*{Aufgabe 2}
\begin{lstlisting}
void Funktion(bool a,bool b){ // might be global variables too
  int y=0;
  if(a){
    y+=2;
  }else{
  ...
  return; // Kein return value, diese werden immer angegeben!
}
\end{lstlisting}
...
Die Diskusion ist heir wichtig!

\subsection*{1.}
Eigentlich ja, aber Nein, wenn z.B. die Fuktion mit anderen Variablentypen Implementierbar ist (für eine Sprache wie C).
\subsection*{2.}
Ja.
